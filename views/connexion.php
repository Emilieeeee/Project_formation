...
<a class="text-center atext" href="<?= site_url('Users/FormulaireCreationCompte')?>" title="page de connexion"> <h4 class="atext a text-info"> Vous n'êtes pas encore inscrit ?   </h2>  </a>
